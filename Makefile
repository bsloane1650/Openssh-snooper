...
prefix=/home/brandon/Documents/College/2014B/ACES102/ssh/install
exec_prefix=${prefix}
...
LDFLAGS=-L. -Lopenbsd-compat/  -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -fstack-protector-all -pie
EXEEXT=
...
PATHSUBS	= \
	...
	-e 's|/usr/bin:/bin:/usr/sbin:/sbin|/usr/bin:/bin:/usr/sbin:/sbin:/home/brandon/Documents/College/2014B/ACES102/ssh/install/bin|g'
